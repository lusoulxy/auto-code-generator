...
import com.silas.generator.helper.fileStrHelper.MapperXMLHelperV2.InnerModules;
...
public class ServiceHelperV2 extends CreateClassHelper{
	...
	public String getOutPutContent() {
		...
		//1。包名
		String packageName =  "package " + packagePath + ".serivce;" + n2;
		//2。导入所依赖的包
		String importNeed = "";
