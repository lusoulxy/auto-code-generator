...
import com.silas.generator.helper.interface_.CreateFileHelperV2;
...
public class MapperXMLHelperV2 extends CreateFileHelperV2 {
	//设置模块是否生成，和生成的顺序；value=0为不生成，数字越小排越前面
	{
		...
		toCreateModule.put("baseColumnList", -1);// 所有字段拼接 Base_Column_List
		toCreateModule.put("resultMap", -2);// 结果集映射
	}
	/**
