...
public abstract class Config {
	{//设置模块参数
//		添加 产物统计数据 模块代码	
		tableName = "T_SCHEDULERDAYREPORT3_BALDATA";//数据库表名
		entityName = "ProductionData";//对应实体类名
		packagePath = "com.hzsh.production";//包名
		module = "production";//模块名
		moduleName = "产物统计数据";//模块中文名，用于生成注释与日志相关
	}
	public static String tableName;//数据库表名
	public static String entityName;//对应实体类名
	public static String packagePath;//包名
	public static String module;//模块名
