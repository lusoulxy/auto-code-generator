...
public class DatabaseMetaMysqlUtil {

    private final static String DATABASE_NAME = "social_network";
    private final static String TABLE_NAME = "user";

    private DatabaseMetaData dbMetaData = null;
    private Connection con = null;
    public static void main(String[] args) {
        DatabaseMetaMysqlUtil metaData = new DatabaseMetaMysqlUtil();
         metaData.getDataBaseInformations();
        // metaData.getAllTableList(null);
        // metaData.getAllViewList(null);
        // metaData.getAllSchemas();
        metaData.getTableColumns(DATABASE_NAME, TABLE_NAME);
        // System.out.println("=======================");
        // metaData.getIndexInfo("root", "user");
        // System.out.println("=======================");
        metaData.getAllPrimaryKeys(DATABASE_NAME, TABLE_NAME);
        // System.out.println("=======================");
        // metaData.getAllExportedKeys("root", "user");
        // System.out.println("=======================");
        // Map<String, Field> columnNameBySchemaNameAndTableName =
        // metaData.getColumnNameBySchemaNameAndTableName("root", "user");
    ...
    private void getDatabaseMetaData() {
        try {
            if (dbMetaData == null) {
                ...
                String url = "jdbc:mysql://120.79.172.52:3306/" + DATABASE_NAME;
                String user = "root";
                String password = "root=1314@=xhh";
