...
public class RecordSaveViewHtmlHepler implements CreateFileHelper,HtmlHelper{
	String HtmlZHName="更新";
	String htmlName ="save_view.html";
	...
	private String bodyTable() {
		...
		for(Column column :colList) {
			...
			if(column.isPk()||column.getRemarkOrigin().indexOf("-not_show")>0) {//自动生成主键，则无需前端输入
				continue;
			}
			String thTd = "";
